...
int main(void)
{
  ...
  while (1)
  {
      ...
      displayLED1(led1);	// GREEN first
      displayLED2(led2);	// RED first
...
void displayLED1(int num) {
    HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_SET);

    switch (num)
    {
    case 0:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_FF_Pin, GPIO_PIN_RESET);
        break;
    case 1:
        HAL_GPIO_WritePin(GPIOB, SEG_BB_Pin | SEG_CC_Pin, GPIO_PIN_RESET);
        break;
    case 2:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 3:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 4:
        HAL_GPIO_WritePin(GPIOB, SEG_BB_Pin | SEG_CC_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 5:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 6:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 7:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin, GPIO_PIN_RESET);
        break;
    case 8:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    case 9:
        HAL_GPIO_WritePin(GPIOB, SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_FF_Pin | SEG_GG_Pin, GPIO_PIN_RESET);
        break;
    default:
        break;
    }
...
static void MX_GPIO_Init(void)
{
  ...
  /* Configure GPIO pins */
  GPIO_InitStruct.Pin = GPIO_PIN_2_Pin | GPIO_PIN_3_Pin | GPIO_PIN_4_Pin | GPIO_PIN_5_Pin | GPIO_PIN_6_Pin | GPIO_PIN_7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = SEG_A_PIN_Pin | SEG_B_PIN_Pin | SEG_C_PIN_Pin | SEG_D_PIN_Pin | SEG_E_PIN_Pin | SEG_F_PIN_Pin | SEG_AA_Pin | SEG_BB_Pin | SEG_CC_Pin | SEG_DD_Pin | SEG_EE_Pin | SEG_FF_Pin | SEG_GG_Pin | SEG_G_PIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
